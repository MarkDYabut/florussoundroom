---
title: "Create, edit and delete service posts"
summary: "Create, edit and delete posts in the services section of your Magic Portfolio."
...
You can create, edit and delete posts by adding, modifying or removing `*.mdx` files in the `src/app/services/posts` directory.
...
---`,
        language: "tsx",
        label: "src/app/services/posts/post-1.mdx"
      }
    ]}
/>
